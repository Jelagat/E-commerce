    ...
    <div class="inner">
      ...
      <div id="content"> 
        ...
        <div id="accordion" class="checkout">
          ...
          <div>
              <form action="<?php echo base_url();?>front/checkout/save_shipping_address" method="post">
            <table class="form">
              <tbody>
                <tr>
                  <td>Full Name:</td>
                  <td><input type="text" class="large-field" value="" name="full_name" required/></td>
                </tr>
              
                <tr>
                  <td>Mobile number:</td>
                  <td><input type="text" class="large-field" value="" name="mobile_no" required/></td>
                </tr>
             
                <tr>
                  <td>email address:</td>
                  <td><input type="email" class="large-field" value="" name="email_address" required/></td>
                </tr>
