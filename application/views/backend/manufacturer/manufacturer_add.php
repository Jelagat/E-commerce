...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <form class="form-horizontal" action="<?php echo base_url(); ?>super_admin/manufacturer/manufacturer_save" method="post" onsubmit="return validateStandard(this)">
                <fieldset>
                    <legend></legend>
                    <div class="control-group">
                        <label class="control-label" for="manufacturer_name">Manufacturer Name (<span style="color:red">*</span>)  </label>
                        <div class="controls">
                            <input type="text" class="span6 typeahead" id="manufacturer_name" err="Enter valide manufacturer name...."  name="manufacturer_name" required >
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea name="manufacturer_description" class="cleditor" id="manufacturer_description" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="control-group">
